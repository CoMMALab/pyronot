#!/usr/bin/env bash
# Build _mppi_ik_cuda_lib.so from _mppi_ik_cuda_kernel.cu.
#
# Usage (from repo root):
#   bash src/pyroffi/cuda_kernels/build_mppi_ik_cuda.sh
#   bash src/pyroffi/cuda_kernels/build_mppi_ik_cuda.sh --debug
#
# Requirements:
#   - nvcc (CUDA toolkit)
...
SRC="${SCRIPT_DIR}/_mppi_ik_cuda_kernel.cu"
OUT="${SCRIPT_DIR}/_mppi_ik_cuda_lib.so"
