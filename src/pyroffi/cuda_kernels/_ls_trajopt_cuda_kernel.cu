...
#define lst_sphere_sphere_dist sphere_sphere_dist
#define lst_sphere_capsule_dist sphere_capsule_dist
#define lst_sphere_box_dist sphere_box_dist
#define lst_sphere_halfspace_dist sphere_halfspace_dist
#define lst_apply_se3 apply_se3_point
