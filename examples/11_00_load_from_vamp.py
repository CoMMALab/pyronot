...
from pyroffi.collision._geometry import Box 
from pyroffi.collision._robot_collision import RobotCollision, RobotCollisionSpherized
from pyroffi._robot import Robot
from pyroffi.collision._utils import *
from pyroffi.collision._obstacles import *
...
def get_configs_path():
    return Path(__file__).parent.parent / "resources/configs"
