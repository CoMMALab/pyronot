"""IK with Collision — CUDA HJCD Solver

Inverse Kinematics with collision avoidance using the CUDA HJCD-IK solver
...
(coordinate-descent + LM) loop:
  ...
  1. Winner selection — all refined CUDA configurations are scored with the
     collision penalty added to the task error.  The least penalised seed is
...
configurations when the local minimum is heavily constrained.
...
def main():
    """Main function for CUDA HJCD-IK with collision avoidance."""
